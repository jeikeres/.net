<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OpcionesPerfil.aspx.vb" Inherits="Web.OpcionesPerfil" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="ADMINISTRACIÓN - Informe de Opciones por Perfil" ShowCollapseButton="true" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
...
<dx:PanelContent runat="server">
    <table style="width: 100%;">
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="gv_datos" runat="server" Theme="Aqua" Width="100%" EnableTheming="True">
                </dx:ASPxGridView>
            </td>
        </tr>
    </table>
