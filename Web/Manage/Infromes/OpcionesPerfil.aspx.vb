...
Public Class OpcionesPerfil
    Inherits System.Web.UI.Page

    Dim INF As New cls_Informes
    Dim _Ds As DataSet
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            CargaGvDatos()
        Else
            If Not Session("DS_INF_OPCIONES_PERFIL") Is Nothing Then
                gv_datos.DataSource = Session("DS_INF_OPCIONES_PERFIL")
            End If
        End If
    End Sub
    ...
    Public Sub CargaGvDatos()
        ...
        _Ds = INF.OpcionesporPerfil(IDs)

        Session("DS_INF_OPCIONES_PERFIL") = _Ds
        gv_datos.DataSource = _Ds
        gv_datos.DataBind()
    End Sub
