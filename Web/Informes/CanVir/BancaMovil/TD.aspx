<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TD.aspx.vb" Inherits="Web.TD_BM" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="BANCA MÓVIL - Tabla Dinámica" ShowCollapseButton="true" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
                                                ...
                                                <table style="background-color: White; width: 100%;">
                                                    <tr>
                                                        <td style="text-align: right; padding: 10px;">
                                                            <dx:ASPxButton ID="closeButton0" runat="server" AutoPostBack="false" Text="Aceptar" Theme="MetropolisBlue">
