<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TD.aspx.vb" Inherits="Web.TD_DVCOM" %>
...
<div style="text-align:right; margin-right:2px; margin-bottom:2px; margin-top:0px;">
                            <dx:ASPxButton ID="ASPxButton4" Height="15" Width="15" runat="server" ToolTip="Ayuda" RenderMode="Link" Style="vertical-align:middle;" >
                                <Image Width="15px" Url="~/App_Themes/Default/img/page/help_blue.png">
                                </Image>
                            </dx:ASPxButton>
</div>
...
<dx:ASPxCallbackPanel ID="cpx_td" runat="server" Width="100%">
    ...
    <div>
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="DAVIVIENDA.COM - Tabla Dinámica" ShowCollapseButton="true" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
<dx:PanelContent runat="server">
        ...
        <tr>
            <td>
                <dx:ASPxPivotGrid ID="pvgx_datos" runat="server" ClientIDMode="AutoID" ClientInstanceName="pivotgrid" DataSourceID="SqlDataGridView" OnFieldValueDisplayText="pvgx_datos_FieldValueDisplayText" Theme="Aqua" Width="99%" EnableTheming="True">
                    <Fields>
                        <dx:PivotGridField ID="fieldProducto" AreaIndex="0" Caption="Año" FieldName="AÑO" Area="RowArea">
                        </dx:PivotGridField>
