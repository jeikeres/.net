<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TEND.aspx.vb" Inherits="Web.TEND_APP" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="APP - Tendencias" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
