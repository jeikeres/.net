    ...
    Public Function Genera_Graficos(ByVal _sValor01 As String, ByVal _sValor02 As String) As Boolean
        ...
        Select Case _sValor01
            ...
            Case Is = 2
                ...
                '-------------------------------------------------------------------------
                _Ds = COMP.Retorna_Info_GraficaSegmento(_sValor02, Canal)
                Dim _iInc_Gr As Integer = 0
                ...
                If Me._Ds.Tables.Count > 0 Then
                    If Me._Ds.Tables(0).Rows.Count > 0 Then
                        ...
                        ' Define the text for the titles.
                        chartTitle2.Text = "Segmentación Clientes"

                        chartTitle2.WordWrap = True
                        chartTitle2.MaxLineCount = 1

                        ' Define the alignment of the titles.
                        chartTitle2.Alignment = Drawing.StringAlignment.Center
                        ...
                        chartTitle2.Font = New Drawing.Font("Tahoma", 10, Drawing.FontStyle.Bold)
                        chartTitle2.TextColor = Drawing.Color.Black
                        chartTitle2.Indent = 10

                        ' Add the titles to the chart.
                        _Tab1_WebChar2.Titles.AddRange(New ChartTitle() {chartTitle2})
                        ' *********************** FIN TITULO DEL GRAFICO************************


                        _Tab1_WebChar2.Series.Clear()
                        _Tab1_WebChar2.BorderOptions.Color = Drawing.Color.White

                        _Tab1_WebChar2.Legend.TextVisible = True

                        'Declaramos una variable del tipo Series
                        Dim series1 As Series = New Series()

                        'Agregamos la serie al componente
                        _Tab1_WebChar2.Series.Add(series1)
                        ...
                        Dim ExplodedPoints As XtraCharts.ExplodedSeriesPointCollection = (CType(_Tab1_WebChar2.Series(0).View, XtraCharts.PieSeriesViewBase)).ExplodedPoints


                        CType(_Tab1_WebChar2.Series(0).View, XtraCharts.PieSeriesViewBase).ExplodedPoints.Clear()
                        CType(_Tab1_WebChar2.Series(0).View, XtraCharts.PieSeriesViewBase).ExplodeMode = PieExplodeMode.All
                        CType(_Tab1_WebChar2.Series(0).View, XtraCharts.PieSeriesViewBase).ExplodedDistancePercentage = 15
                        ...
                        _Tab1_WebChar2.Legend.AlignmentVertical = LegendAlignmentVertical.BottomOutside
                        _Tab1_WebChar2.Legend.AlignmentHorizontal = LegendAlignmentHorizontal.Center
                        _Tab1_WebChar2.Legend.Antialiasing = True
                        _Tab1_WebChar2.Legend.Direction = LegendDirection.LeftToRight
                        _Tab1_WebChar2.DataSource = _Ds
                        _Tab1_WebChar2.DataBind()

                    End If
                End If
                Me._Tab1_WebChar2.Visible = True
