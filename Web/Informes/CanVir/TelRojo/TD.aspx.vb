...
Public Class TD_TR
    ...
    ' Calcular %
    Protected Sub pvgx_datos_CustomCellDisplayText(sender As Object, e As DevExpress.Web.ASPxPivotGrid.PivotCellDisplayTextEventArgs) Handles pvgx_datos.CustomCellDisplayText
        If Object.ReferenceEquals(e.DataField, pvgx_datos.Fields("PorcentajeCantidad")) Then

            Dim fieldCantidad As DevExpress.Web.ASPxPivotGrid.PivotGridField = pvgx_datos.Fields("fieldCantidad")
        ...
        If Object.ReferenceEquals(e.DataField, pvgx_datos.Fields("PorcentajeDeuda")) Then
            ...
            Dim fieldDeuda As DevExpress.Web.ASPxPivotGrid.PivotGridField = pvgx_datos.Fields("fieldDeuda")
        ...
        If Object.ReferenceEquals(e.DataField, pvgx_datos.Fields("PorcentajeValor")) Then
            ...
            Dim fieldValor As DevExpress.Web.ASPxPivotGrid.PivotGridField = pvgx_datos.Fields("fieldValor")
