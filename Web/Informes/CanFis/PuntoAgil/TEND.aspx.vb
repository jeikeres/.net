...
Public Class TEND_PTOAG
    ...
    Const Canal As Integer = 26

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then

            Genera_Graficos(1, "Consulta de Saldo", _Tab1_WebChar1, "Cifras en millones")
            Genera_Graficos(2, "Extractos", _Tab1_WebChar2, "Cifras en millones")
            Genera_Graficos(3, "Consulta de Movimiento", _Tab1_WebChar3, "Cifras en millones")
            Genera_Graficos(4, "Impresiones", _Tab1_WebChar4, "Cifras en millones")
