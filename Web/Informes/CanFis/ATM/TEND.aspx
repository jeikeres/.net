<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TEND.aspx.vb" Inherits="Web.TEND_ATM" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="ATM - Tendencias" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
