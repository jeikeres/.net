...
Public Class TEND_ATM
    ...
    Const Canal As Integer = 3

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            Genera_Graficos(1, "TX Sin Consultas", _Tab1_WebChar1, "Cifras en millones")
            Genera_Graficos(2, "Consultas", _Tab1_WebChar2, "Cifras en millones")
            Genera_Graficos(3, "Montos", _Tab1_WebChar3, "Montos en millones", "$")
            Genera_Graficos(4, "Clientes", _Tab1_WebChar4, "Cifras en millones")
        End If
    End Sub
