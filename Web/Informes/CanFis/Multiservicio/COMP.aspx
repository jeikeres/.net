<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="COMP.aspx.vb" Inherits="Web.COMP_MSVC" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="MULTISERVICIO - Composición" ShowCollapseButton="true" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
