...
Public Class TEND_MSVC
    ...
    Const Canal As Integer = 25

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            Genera_Graficos(1, "Pagos", _Tab1_WebChar1, "Cifras en millones")
            Genera_Graficos(2, "Retiros", _Tab1_WebChar2, "Cifras en millones")
            Genera_Graficos(3, "Depositos", _Tab1_WebChar3, "Cifras en millones")
        End If
    End Sub
