<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TEND.aspx.vb" Inherits="Web.TEND_ATM_OR" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="ATM OTRAS REDES - Tendencias" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                                        ...
                                                        <td align="left" style=" width:49%;" valign="top">
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td align="center" valign="top">
                                                                                    <dxchartsui:WebChartControl ID="_Tab1_WebChar4" runat="server" CrosshairEnabled="True" Height="260px" Width="470px">
