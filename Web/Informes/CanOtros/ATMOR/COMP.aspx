<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="COMP.aspx.vb" Inherits="Web.COMP_ATM_OR" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="ATM OTRAS REDES - Composición" ShowCollapseButton="true" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
