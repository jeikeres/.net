<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TD.aspx.vb" Inherits="Web.TD_ATM_OR" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="ATM OTRAS REDES - Tabla Dinámica" ShowCollapseButton="true" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
            ...
            <td>
                <dx:ASPxPivotGrid ID="pvgx_datos" runat="server" ClientIDMode="AutoID" ClientInstanceName="pivotgrid" DataSourceID="SqlDataGridView" OnFieldValueDisplayText="pvgx_datos_FieldValueDisplayText" Theme="Aqua" Width="99%" EnableTheming="True">
                    <Fields>
                        ...
                        <dx:PivotGridField ID="fieldDiaSemana" AreaIndex="6" Caption="Día Semana" FieldName="DIASEMANA" GroupInterval="DateDay" UnboundFieldName="fieldDiaSemana">
                        </dx:PivotGridField>
