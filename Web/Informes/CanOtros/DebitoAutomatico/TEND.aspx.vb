...
Public Class TEND_DBAUTO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Genera_Graficos(2, "Montos", _Tab1_WebChar2, "Montos en millones")
            Genera_Graficos(3, "Clientes", _Tab1_WebChar3, "Cifras en millones")

            ' CAMBIAR LOS INDICES (1,2,3,4 POR LOS CORRESPONDIENTES UNA VEZ REALIZADO EL 
            Genera_Graficos(4, "Cobros por Servicio", _Tab1_WebChar4, "Cifras en millones")
            Genera_Graficos(5, "Pagos Davivienda", _Tab1_WebChar5, "Cifras en millones")
            Genera_Graficos(6, "Transferencias", _Tab1_WebChar6, "Cifras en millones")
            Genera_Graficos(7, "Domiciliación", _Tab1_WebChar7, "Cifras en millones")
            Genera_Graficos(8, "Abono en Cuenta", _Tab1_WebChar8, "Cifras en millones")
