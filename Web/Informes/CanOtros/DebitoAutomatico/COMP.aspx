<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="COMP.aspx.vb" Inherits="Web.COMP_DBAUTO" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="DÉBITO AUTOMÁTICO - Composición" ShowCollapseButton="true" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
