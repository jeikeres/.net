<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TEND.aspx.vb" Inherits="Web.TEND_POS" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="POS - Tendencias" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
