<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="COMP.aspx.vb" Inherits="Web.COMP_CB" %>
...
<dx:ASPxRoundPanel ID="rdpx_header" runat="server" HeaderText="CORRESPONSAL BANCARIO - Composición" ShowCollapseButton="true" Theme="MetropolisBlue" Width="100%">
            <PanelCollection>
